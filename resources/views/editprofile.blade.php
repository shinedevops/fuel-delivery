                    ...
                    <div class="profile-edit-box">
                        <div class="profile-edit-header">
                            ...
                            <a href="{{ route('edit-profile', ['user_id' => auth()->user()->id]) }}"
                                class="button edit-proile-btn">Edit profile</a>

                        </div>
                        <div class="edit-detail-pl">
                            <ul>
                                <li><span class="edit-detail-icon"><i class="fa-solid fa-envelope"></i></span><a
                                        href="">rogerbergson@gmail.com</a></li>
                                <li><span class="edit-detail-icon"><i class="fa-solid fa-phone"></i></span><a
                                        href="">+1245-1231-123</a></li>
                                <li><span class="edit-detail-icon"><svg xmlns="http://www.w3.org/2000/svg" width="52"
                                            height="13" viewBox="0 0 52 13" fill="none">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="completed-order-tab" data-bs-toggle="tab"
                            data-bs-target="#completed-order" type="button" role="tab" aria-controls="completed-order"
                            aria-selected="false"><i class="fa-solid fa-circle-check"></i>Completed
                        </button>
                    </div>
