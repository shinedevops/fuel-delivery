                            ...
                            <div class="edit-input-bx">
                                ...
                                <form class="profile-edit-form" action="{{ route('updateProfile', ['id' => auth()->user()->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            <div class="formfield">
                                                <input type="email" class="form-control" name="email" placeholder="Enter your email" value="{{ $user->email ?? old('email') }}" readonly>
                                        ...
                                        <div class="form-group">
                                            <div class="formfield">
                                                <input type="text" class="form-control" name="phone" placeholder="Enter your phone number" value="{{ $userDetails->phone_number ?? old('phone') }}">
                                                <span class="form-icon">
                                        ...
                                        <div class="form-group">
                                            <div class="formfield">
                                                <input type="date" class="form-control" name="date" placeholder="Enter your date of birth" value="{{ $userDetails->date ?? old('date') }}">
                                                <span class="form-icon">
